...
-- Only required if you have packerj configured as `opt`
...
if vscode then
  packer.init {
    compile_path = "/Users/aaronhunt/.cache/nvim_profiles/vscode/nvim/packer_compiled.lua",
    install_path = "/Users/aaronhunt/.cache/nvim_profiles/vscode/nvim/packer",
    profile = {
      enable = true,
      threshold = 1,
    },
  }
  print("in vscode condition", vim.g.vscode)
...
-- /Users/aaronhunt/.local/share/nvim/typrstats
     use {
      "nvzone/typr",
      requires = {
        "nvzone/volt",
